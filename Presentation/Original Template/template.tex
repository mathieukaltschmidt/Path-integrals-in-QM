...
%General Information
\title{Die Pfadintegral-Formulierung der QM}
...
\institute{Institut für theoretische Physik - Universität Heidelberg}
...
\begin{frame}{Metropolis titleformats}
	  supports 4 different titleformats:
	\begin{itemize}
		\item Regular
...
\begin{frame}[fragile]{Frame footer}
      defines a custom beamer template to add a text to the footer. It can be set via
...
{\setbeamercolor{palette primary}{fg=black, bg=red}
